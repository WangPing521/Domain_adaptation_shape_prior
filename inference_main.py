...
Smodel = Smodel.eval()
weight = f'../../PHD_documents/papers_work/domain_adaptation/visualization_models/our/last.pth'
...
for batch_idT, data_T in enumerate(valT_loader):
    ...
    save_images(preds_T.max(1)[1], names=filenameT, root='../../PHD_documents/papers_work/domain_adaptation/visualization_models/our/segs', mode='predictions',
            iter=100)
