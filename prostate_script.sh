...
"python main.py seed=123 Optim.lr=0.00001 Data_input.dataset=prostate Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.source=prostate DA.target=promise DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/s2m_entDA21_601reg_seed1"
"python main.py seed=231 Optim.lr=0.00001 Data_input.dataset=prostate Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.source=prostate DA.target=promise DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/s2m_entDA21_601reg_seed2"
"python main.py seed=321 Optim.lr=0.00001 Data_input.dataset=prostate Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.source=prostate DA.target=promise DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/s2m_entDA21_601reg_seed3"

"python main.py seed=123 Optim.lr=0.00001 Data_input.dataset=prostate Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.source=prostate DA.target=promise DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.00000001 Trainer.save_dir=${save_dir}/s2m_entDA21_701reg_seed1"
"python main.py seed=231 Optim.lr=0.00001 Data_input.dataset=prostate Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.source=prostate DA.target=promise DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.00000001 Trainer.save_dir=${save_dir}/s2m_entDA21_701reg_seed2"
"python main.py seed=321 Optim.lr=0.00001 Data_input.dataset=prostate Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.source=prostate DA.target=promise DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.00000001 Trainer.save_dir=${save_dir}/s2m_entDA21_701reg_seed3"
