...
# entda
"python main.py seed=10 Optim.lr=0.00001 Data_input.dataset=prostate Data.kfold=0 Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.000001 Trainer.save_dir=${save_dir}/entDA_501reg_seed1"
"python main.py seed=20 Optim.lr=0.00001 Data_input.dataset=prostate Data.kfold=0 Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.000001 Trainer.save_dir=${save_dir}/entDA_501reg_seed2"
"python main.py seed=30 Optim.lr=0.00001 Data_input.dataset=prostate Data.kfold=0 Data_input.num_class=2 Trainer.name=entda DA.double_bn=True DA.batchsize_indicator=9 Scheduler.RegScheduler.max_value=0.000001 Trainer.save_dir=${save_dir}/entDA_501reg_seed3"
