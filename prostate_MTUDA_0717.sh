...
"python MTUDA_main.py seed=10 Data_input.dataset=prostate Data_input.num_class=2 Optim.lr=0.000005 DataLoader.batch_size=63 weights.lkd_weight.max_value=1 weights.consistency.max_value=0.001 Trainer.save_dir=${save_dir}/505_bs63_lkd1_cons201_seed1"
"python MTUDA_main.py seed=20 Data_input.dataset=prostate Data_input.num_class=2 Optim.lr=0.000005 DataLoader.batch_size=63 weights.lkd_weight.max_value=1 weights.consistency.max_value=0.001 Trainer.save_dir=${save_dir}/505_bs63_lkd1_cons201_seed2"
"python MTUDA_main.py seed=30 Data_input.dataset=prostate Data_input.num_class=2 Optim.lr=0.000005 DataLoader.batch_size=63 weights.lkd_weight.max_value=1 weights.consistency.max_value=0.001 Trainer.save_dir=${save_dir}/505_bs63_lkd1_cons201_seed3"

"python MTUDA_main.py seed=10 Data_input.dataset=prostate Data_input.num_class=2 Optim.lr=0.000005 DataLoader.batch_size=63 weights.lkd_weight.max_value=1 weights.consistency.max_value=0.0005 Trainer.save_dir=${save_dir}/505_bs63_lkd1_cons305_seed1"
"python MTUDA_main.py seed=20 Data_input.dataset=prostate Data_input.num_class=2 Optim.lr=0.000005 DataLoader.batch_size=63 weights.lkd_weight.max_value=1 weights.consistency.max_value=0.0005 Trainer.save_dir=${save_dir}/505_bs63_lkd1_cons305_seed2"
"python MTUDA_main.py seed=30 Data_input.dataset=prostate Data_input.num_class=2 Optim.lr=0.000005 DataLoader.batch_size=63 weights.lkd_weight.max_value=1 weights.consistency.max_value=0.0005 Trainer.save_dir=${save_dir}/505_bs63_lkd1_cons305_seed3"
