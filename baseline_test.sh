...
declare -a StringArray=(
  "python main.py seed=123 Optim.lr=0.0001 Trainer.name=baseline DA.source=CT DA.target=MRI   Trainer.save_dir=${save_dir}/CT2MRI_301lr_seed1"
  ...
  "python main.py seed=123 Optim.lr=0.0001 Trainer.name=baseline DA.source=MRI DA.target=CT   Trainer.save_dir=${save_dir}/MRI2CT_301lr_seed1"
