...
"python PointCloudUDA_main.py seed=10 Optim.lr=0.00001 DataLoader.batch_size=4 weights=0.001 Trainer.save_dir=${save_dir}/bs63_201dis_seed1"
...
"python PointCloudUDA_main.py seed=10 Optim.lr=0.00001 DataLoader.batch_size=4 weights=0.01 Trainer.save_dir=${save_dir}/bs63_101dis_seed1"
...
"python PointCloudUDA_main.py seed=10 Optim.lr=0.00001 DataLoader.batch_size=4 weights=0.2 Trainer.save_dir=${save_dir}/bs63_02dis_seed1"
...
"python PointCloudUDA_main.py seed=10 Optim.lr=0.00001 DataLoader.batch_size=4 weights=0.5 Trainer.save_dir=${save_dir}/bs63_05dis_seed1"
